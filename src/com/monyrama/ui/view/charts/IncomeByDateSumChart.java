...
public class IncomeByDateSumChart extends JFrame {
	public IncomeByDateSumChart(Collection<PIncome> incomeItems, String incomeSourceName) {        
        SortedMap<Long, BigDecimal> sumByDateMap = new TreeMap<Long, BigDecimal>();
        
        for(PIncome incomeItem : incomeItems) {
        	BigDecimal sumByDate = sumByDateMap.get(dateTimeToLongOnlyDate(incomeItem.getLastChangeDate()));
        	if(sumByDate == null) {
        		sumByDateMap.put(dateTimeToLongOnlyDate(incomeItem.getLastChangeDate()), incomeItem.getSumm());
        	} else {
        		sumByDate = sumByDate.add(incomeItem.getSumm());
        		sumByDateMap.put(dateTimeToLongOnlyDate(incomeItem.getLastChangeDate()), sumByDate);
        	}        	
        }	      
        ...
        String title = Resources.getString("charts.labels.incomebydate") + " (" + Resources.getString("labels.incomes.source") + ": " + incomeSourceName + ")";
