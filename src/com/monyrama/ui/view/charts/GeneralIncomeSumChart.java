...
public class GeneralIncomeSumChart extends JFrame {
	public GeneralIncomeSumChart(Collection<PIncome> spentUnits, String expensesPlanName) {
        ...
        for(PIncome spentUnit : spentUnits) {
        ...
        String title = Resources.getString("charts.labels.generalincomesum") + " (" + Resources.getString("labels.incomes.source") + ": " + expensesPlanName + ")";
