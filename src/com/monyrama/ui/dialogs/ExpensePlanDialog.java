 ...
 *
 */
public abstract class ExpensePlanDialog extends EscapeDialog {
	...
	/**
	 * Opens New Budget Dialog
	 */
	public static void openNewDialog() {
		ExpensePlanDialog newDialog = new NewExpensePlanDialog();
	...
	private void setFields() {
		nameField.setText(expensePlan.getName());		
		currencyBox.setSelectedItem(expensePlan.getCurrency());		
		commentsField.setText(expensePlan.getComment());
	}
	...
	protected void save() {
		ExpensePlanController.instance().createOrUpdate(expensePlan);
	}
